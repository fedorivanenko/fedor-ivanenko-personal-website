...
function RotationWheel({
  ...
  const sourceRef = React.useRef<"gesture" | "inertia" | "key" | "wheel" | "drag">("gesture");
  ...
  return (
    <div
      ...
      role="listbox"
      className="select-none touch-none cursor-grab relative overflow-hidden outline-none focus:ring-1 h-full"
      style={{
        perspective: "64rem",
        ["--rad" as string]: RAD,
        ["--h" as string]: "2em",
