  ...
  return (
    <footer
      className={cn(
        ...
        "w-full max-w-[var(--content-width)] px-5 flex-row gap-x-4 sm:gap-x-6 gap-y-2 space-y-0 text-sm text-muted-foreground mt-auto pt-20 md:pt-40 stagger-5 items-baseline flex-wrap "
      )}
    >
